...
import TableVisitShopHistory from "../table"
import 'swiper/css';
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (result.status === 200) {
                ...
                switch (data.customer.hearing_item1_id) {
                    case 1:
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        setHearingItem1('店舗以外の看板・広告を見て ' + data.customer.hearing_item1_value + 'の場所で見ました')
                        break;
                    case 4:
                        setHearingItem1('折込チラシを見て ' + hearingNews[data.customer.hearing_item1_value])
                        break;
                    case 5:
                        setHearingItem1('インターネットを見て ' + hearingInternet[data.customer.hearing_item1_value])
                        break;
                    case 6:
                        setHearingItem1('紹介されて ' + data.customer.hearing_item1_value)
                        break;
                    case 7:
                        setHearingItem1('その他 ' + data.customer.hearing_item1_value)
                        break;
...
export default withRouter(FormCustomerEdit);
